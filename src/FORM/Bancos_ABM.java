 ...
 * @author user
 */
public class Bancos_ABM extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bancos_ABM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
