...
public class Cuentas_asociadas_agregar_detalle_buscar_cuenta extends javax.swing.JFrame {

    public Cuentas_asociadas_agregar_detalle_buscar_cuenta() {
        initComponents();
        ...
        Metodos.Cuentas_asociadas_agregar_detalle_buscar_cuenta_cargar_jtable();
    }
    ...
    private void jTable1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTable1KeyPressed
        ...
        if ((evt.getKeyCode() == KeyEvent.VK_ENTER)) {
            this.setVisible(false);
            Metodos.Cuentas_asociadas_agregar_cuenta_asociada_seleccionar();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cuentas_asociadas_agregar_detalle_buscar_cuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
