...
public class Cuentas_bancarias extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.setVisible(false);
        new Cuentas_bancarias_ABM().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cuentas_bancarias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
