...
public class Compras_detalle_modificar extends javax.swing.JFrame {
    
    public Compras_detalle_modificar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Compras_detalle_modificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
