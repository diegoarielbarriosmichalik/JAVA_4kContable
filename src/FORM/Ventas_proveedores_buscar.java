...
public class Ventas_proveedores_buscar extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventas_proveedores_buscar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
